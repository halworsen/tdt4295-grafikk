...
#
# tdt4295-graphics.tcl: Tcl script for re-creating project 'tdt4295-graphics'
#
# Generated by Vivado on Thu Sep 09 11:17:37 CEST 2021
...
#
# 1. This project restoration tcl script (tdt4295-graphics.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/ludvig/code/NTNU/dmpro/tdt4295-grafikk/fpga/tdt4295-graphics/arty-a7-35.xdc"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/arty-a7-35.xdc"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "tdt4295-graphics"
...
set script_file "tdt4295-graphics.tcl"
...
set file "[file normalize "$origin_dir/arty-a7-35.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "tdt4295-graphics/arty-a7-35.xdc"
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/tdt4295-graphics.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/tdt4295-graphics.srcs/utils_1/imports/impl_1" -objects $obj
