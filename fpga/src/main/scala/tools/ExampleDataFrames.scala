...
object ExampleDataFrames {
  val square1 = {
    ...
    bundle.points(0).x := decToFP(-0.5)
    bundle.points(0).y := decToFP(0.5)
    bundle.points(0).z := decToFP(0)
    bundle.points(0).w := decToFP(0)
    bundle.points(1).x := decToFP(0.5)
    bundle.points(1).y := decToFP(0.5)
    bundle.points(1).z := decToFP(0)
    bundle.points(1).w := decToFP(0)
    bundle.points(2).x := decToFP(0.5)
    bundle.points(2).y := decToFP(-0.5)
    bundle.points(2).z := decToFP(0)
    bundle.points(2).w := decToFP(0)
    bundle.points(3).x := decToFP(-0.5)
    bundle.points(3).y := decToFP(-0.5)
    bundle.points(3).z := decToFP(0)
    bundle.points(3).w := decToFP(0)
