...
object ExampleDataFrames {
  val square1 = {
    ...
    bundle.points(0).x := doubleToFP(-0.5)
    bundle.points(0).y := doubleToFP(0.5)
    bundle.points(0).z := doubleToFP(0)
    bundle.points(0).w := doubleToFP(1)
    bundle.points(1).x := doubleToFP(0.5)
    bundle.points(1).y := doubleToFP(0.5)
    bundle.points(1).z := doubleToFP(0)
    bundle.points(1).w := doubleToFP(1)
    bundle.points(2).x := doubleToFP(0.5)
    bundle.points(2).y := doubleToFP(-0.5)
    bundle.points(2).z := doubleToFP(0)
    bundle.points(2).w := doubleToFP(1)
    bundle.points(3).x := doubleToFP(-0.5)
    bundle.points(3).y := doubleToFP(-0.5)
    bundle.points(3).z := doubleToFP(0)
    bundle.points(3).w := doubleToFP(1)
